...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/registered_domains_menu.png?raw=true  
  It will ask you to choose a domain name, if the name is already taken Route 53 will run a quick check and inform you.
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/find_unregistered_name.png?raw=true
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/basic_hostedzone.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/creating_Arecord.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/ACM_menu.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/ACM_create_cert.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/ACM_create_records_Route53.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/loadbalancer_listeners.png?raw=true)
...
![alt text](https://github.com/fjameson/reactWebsiteInAWSCloud/blob/main/hostedzone_loadbalancer.png?raw=true)
